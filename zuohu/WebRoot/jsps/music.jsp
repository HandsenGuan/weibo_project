...
<script src="../myjs/message/publishmusic.js"></script>
	...
	<div class="container">
		<div class="row">
			<div class=" col-md-offset-2 col-md-8">
				...
				<div class="panel">
					<div class="row">
						<div id="music_title" style="text-align:center;margin-top:20px;"></div>
					</div>
					<div class="row">
						<div id="music_content" style="text-align:center;margin-top:20px;"></div>
					</div>
				</div>
			</div>
		</div>
